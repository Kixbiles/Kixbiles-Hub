...
hatset('MeshPartAccessory','HumanoidRootPart',CFrame.new(),reanim['MeshPartAccessory'].Handle.AccessoryWeld.C0:Lerp(CF(7+0*math.cos(sine/67),1+0*math.cos(sine/67),1+1.1*math.cos(sine/67))*ANGLES(RAD(-90+0*math.cos(sine/67)),RAD(-41+360*math.cos(sine/67)),RAD(0+0*math.cos(sine/67))),1),false)
...
RJ.C0 = RJ.C0:Lerp(CF(0+0*math.cos(sine/13),1+1.1*math.cos(sine/13),0+0*math.cos(sine/13))*ANGLES(RAD(0+0*math.cos(sine/13)),RAD(0+0*math.cos(sine/13)),RAD(0+0*math.cos(sine/13))),.3)
...
reanim['MeshPartAccessory'].Handle.AccessoryWeld.C0 = reanim['MeshPartAccessory'].Handle.AccessoryWeld.C0:Lerp(CF(7+0*math.cos(sine/67),1+0*math.cos(sine/67),1+1.1*math.cos(sine/67))*ANGLES(RAD(-90+0*math.cos(sine/67)),RAD(-41+360*math.cos(sine/67)),RAD(0+0*math.cos(sine/67))),.3)
