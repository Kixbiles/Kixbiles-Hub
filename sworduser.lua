...
hatset('MeshPartAccessory','Right Arm',CFrame.new(),reanim['MeshPartAccessory'].Handle.AccessoryWeld.C0:Lerp(CF(2+0*math.cos(sine/13),3+0*math.cos(sine/13),0+0*math.cos(sine/13))*ANGLES(RAD(24+0*math.cos(sine/13)),RAD(-119+0*math.cos(sine/13)),RAD(28+0*math.cos(sine/13))),1),false)
...
RJ.C0 = RJ.C0:Lerp(CF(0+0*math.cos(sine/3),1.4+1.2*math.cos(sine/3),0+0*math.cos(sine/3))*ANGLES(RAD(0+0*math.cos(sine/3)),RAD(0+0*math.cos(sine/3)),RAD(0+0*math.cos(sine/3))),.3)
RS.C0 = RS.C0:Lerp(CF(1.3+0*math.cos(sine/3),0.5+0*math.cos(sine/3),0+0*math.cos(sine/3))*ANGLES(RAD(180+0*math.cos(sine/3)),RAD(69+0*math.cos(sine/3)),RAD(106+0*math.cos(sine/3))),.3)
LS.C0 = LS.C0:Lerp(CF(-1.5+0*math.cos(sine/3),0.5+0*math.cos(sine/3),0+0*math.cos(sine/3))*ANGLES(RAD(0+-47*math.cos(sine/3)),RAD(22+0*math.cos(sine/3)),RAD(-34+0*math.cos(sine/3))),.3)
RH.C0 = RH.C0:Lerp(CF(0.5+0*math.cos(sine/13),0+0*math.cos(sine/13),0+0*math.cos(sine/13))*ANGLES(RAD(0+0*math.cos(sine/13)),RAD(0+0*math.cos(sine/13)),RAD(0+0*math.cos(sine/13))),.3)
...
NECK.C0 = NECK.C0:Lerp(CF(0+0*math.cos(sine/13),1+0*math.cos(sine/13),0+0*math.cos(sine/13))*ANGLES(RAD(0+0*math.cos(sine/13)),RAD(0+0*math.cos(sine/13)),RAD(0+0*math.cos(sine/13))),.3)
RJ.C0 = RJ.C0:Lerp(CF(0+0*math.cos(sine/13),6+-2*math.cos(sine/13),0+0*math.cos(sine/13))*ANGLES(RAD(0+0*math.cos(sine/13)),RAD(0+0*math.cos(sine/13)),RAD(0+0*math.cos(sine/13))),.3)
RS.C0 = RS.C0:Lerp(CF(1.3+0*math.cos(sine/13),0.5+0*math.cos(sine/13),0+0*math.cos(sine/13))*ANGLES(RAD(156+0*math.cos(sine/13)),RAD(11+0*math.cos(sine/13)),RAD(0+0*math.cos(sine/13))),.3)
...
RJ.C0 = RJ.C0:Lerp(CF(0+0*math.cos(sine/13),1.1+1.2*math.cos(sine/13),0+0*math.cos(sine/13)*lookvel)*ANGLES(RAD(-67+0*math.cos(sine/13))*lookvel,RAD(0+0*math.cos(sine/13)),RAD(0+0*math.cos(sine/13))*rightvel),.3)
RS.C0 = RS.C0:Lerp(CF(1.3+0*math.cos(sine/13),0.5+0*math.cos(sine/13),0+0*math.cos(sine/13)*lookvel)*ANGLES(RAD(156+0*math.cos(sine/13))*lookvel,RAD(11+0*math.cos(sine/13)),RAD(98+0*math.cos(sine/13))*rightvel),.3)
LS.C0 = LS.C0:Lerp(CF(-1.5+0*math.cos(sine/13),0.5+0*math.cos(sine/13),0+0*math.cos(sine/13)*lookvel)*ANGLES(RAD(0+0*math.cos(sine/13))*lookvel,RAD(22+0*math.cos(sine/13)),RAD(-34+0*math.cos(sine/13))*rightvel),.3)
RH.C0 = RH.C0:Lerp(CF(0.5+0*math.cos(sine/13),0+0*math.cos(sine/13),0+0*math.cos(sine/13)*lookvel)*ANGLES(RAD(0+0*math.cos(sine/13))*lookvel,RAD(0+0*math.cos(sine/13)),RAD(0+0*math.cos(sine/13))*rightvel),.3)
